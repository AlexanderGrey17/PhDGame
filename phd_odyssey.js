...
function LettersPanel({
  ...
  const renderLetter = () => {
    ...
    if (letter.type === "finance_summary") {
      ...
      }, "\u26A0\uFE0F Funds are running low. Apply for external funds.")));
    }

    // ── Advisor letter letter ──
    if (letter.type === "advisor_letter") {
      return /*#__PURE__*/React.createElement("div", {
        style: {
      ...
      }, "LETTER FROM YOUR ADVISOR"), /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: 13,
          color: C.text,
          lineHeight: 1.9,
      ...
      }, "Dear Student,"), /*#__PURE__*/React.createElement("p", {
        style: {
          marginBottom: 8
        }
      }, "Congratulations on accepting the PhD offer and welcome to the program. To help you succeed during your PhD, please keep the following points in mind:"), /*#__PURE__*/React.createElement("p", {
        style: {
          marginBottom: 8
        }
      }, "1. Pass the ", /*#__PURE__*/React.createElement("strong", {
        style: {
          color: C.green
        }
      }, "comprehensive examination"), " before ", /*#__PURE__*/React.createElement("strong", {
        style: {
          color: C.red
        }
      }, "the end of Year 2"), ". You will have two attempts: July of Year 2 and December of Year 2 (final attempt)."), /*#__PURE__*/React.createElement("p", {
        style: {
          marginBottom: 8
        }
      }, "2. Submit at least ", /*#__PURE__*/React.createElement("strong", {
        style: {
          color: C.red
        }
      }, "three"), " research papers before starting to write your thesis."), /*#__PURE__*/React.createElement("p", {
        style: {
          marginBottom: 8
        }
      }, "3. Maintain good ", /*#__PURE__*/React.createElement("strong", {
        style: {
          color: C.green
        }
      }, "mental health"), "\u2014this is essential for sustaining progress throughout your PhD."), /*#__PURE__*/React.createElement("p", {
        style: {
          marginBottom: 8
        }
      }, "4. Keep your financial situation stable. Seek ", /*#__PURE__*/React.createElement("strong", {
        style: {
          color: C.green
        }
      }, "external funding"), " if necessary."), /*#__PURE__*/React.createElement("p", {
        style: {
          marginBottom: 8
        }
      }, "5. Maintain a professional and productive ", /*#__PURE__*/React.createElement("strong", {
        style: {
          color: C.green
        }
      }, "relationship"), " with your advisor."), /*#__PURE__*/React.createElement("p", null, "Regards,", /*#__PURE__*/React.createElement("br", null), "Your PhD Advisor"))));
    }
...
function PhDOdyssey() {
  ...
  // ── Dismiss welcome → show advisor letter -> show finance summary ───────────────────────────
  ...
  }, "PhD Odyssey \xB7 Generated by \xB7 Claude.AI \xB7 AlexanderGrey")));
}
